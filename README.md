...
Welcome to my portfolio for the Computer Vision course (ITAI1378). This repository showcases my learning journey, assignments, and projects. It demonstrates the skills and knowledge I acquired during the course, including practical applications in Python, AI concepts, and computer vision tools.
...
1. **Modules**: Each module folder includes:
   - **Labs**: Practical exercises to reinforce learning.
   - **Assignments**: Application of concepts in real-world scenarios.
   - **Reflections**: Personal insights and lessons learned.

2. **Final Project**: A capstone project showcasing a significant application of computer vision techniques.

3. **Resources**: Additional materials such as articles, videos, and images that supported my learning.

4. **README.md**: This file provides an overview of the repository and my learning journey.
...
- **Skills Gained**: Implementing and fine-tuning advanced CNN models.

### Module 09: Advanced Object Detection and Recognition
...
- **Skills Gained**: Creating and evaluating generative models.

### Module 12: Autonomous Systems (Agents) and Computer Vision
- **Overview**: Application of computer vision in autonomous systems like robots and self-driving cars.
- **Key Concepts**: Visual SLAM, path planning, and reinforcement learning.
- **Skills Gained**: Integrating vision systems into autonomous agents.

### Final Project
- **Topic**: Real-time Object Detection with YOLOv5.
- **Achievements**:
  - Built and trained a custom object detection model.
  - Deployed the model in a live video stream.
  - Documented findings in a comprehensive report.

## Learning Journey

This portfolio reflects my progression from foundational concepts to advanced computer vision techniques. I faced challenges in understanding complex algorithms but overcame them through consistent practice and leveraging online resources. Key takeaways include:

- **Skill Development**: Proficiency in Python, OpenCV, and TensorFlow.
- **Problem-Solving**: Tackling real-world problems with innovative solutions.
- **Collaboration**: Working with peers and integrating feedback into my work.

## Next Steps

I plan to use these skills in future projects and internships, focusing on AI-driven solutions in real-world applications. Stay connected for updates on my journey.
